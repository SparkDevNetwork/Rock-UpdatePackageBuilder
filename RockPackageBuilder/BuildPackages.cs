...
namespace RockPackageBuilder
{
    ...
    class BuildPackages
    {
        ...
        /// </summary>
        static List<string> NON_WEB_PROJECTS = new List<string> { "dotliquid", "rock", "rock.mailgun", "rock.mandrill", "rock.migrations", "rock.nmi", "rock.payflowpro", "rock.rest", "rock.signnow", "rock.version", "signnowsdk" };
